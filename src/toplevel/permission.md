# Assign AWS IAM Permissions for MATLAB Users on Windows

AWS® administrators can grant the least privileged permissions to end users to deploy MATLAB® on a Windows® instance in AWS. If you are an end user, contact your AWS administrator to grant you the necessary permissions.
